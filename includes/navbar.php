...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="./" class="brand-link">
        <img src="./src/images/AdminLTELogo.png" alt="" class="brand-image img-circle elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="WIN_20241103_20_08_40_Pro.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?= in_array($current_page, ['index.php']) ? 'menu-open' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="dash.php" class="nav-link <?= ($current_page === 'dash.php') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Dashboard</p>
                            </a>
                            <li class="nav-item">
                            <a href="manage.php" class="nav-link <?= ($current_page === '') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Manage</p>
                            </a>
                        </li>
